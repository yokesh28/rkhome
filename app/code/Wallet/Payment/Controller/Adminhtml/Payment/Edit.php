...
class Edit extends \Wallet\Payment\Controller\Adminhtml\Payment
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('wallet_payment_payment', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Payments'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Payment'));
        return $resultPage;
    }
}
